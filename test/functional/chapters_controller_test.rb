...
class ChaptersControllerTest < ActionController::TestCase
  ...
  test "should create chapter" do
    assert_difference('Chapter.count') do
      post :create, chapter: { course_id: @chapter.course_id, name: @chapter.name, syllabus_id: @chapter.syllabus_id }
    end
  ...
  test "should update chapter" do
    put :update, id: @chapter, chapter: { course_id: @chapter.course_id, name: @chapter.name, syllabus_id: @chapter.syllabus_id }
    assert_redirected_to chapter_path(assigns(:chapter))
  end
